...
@implementation MCRefreshTableFooterView
...
-(void)setState:(MCRefreshTableFooterViewState)state {
    _state = state;
    switch (state) {
        case MCRefreshTableFooterViewStateNormal: {
        ...
        case MCRefreshTableFooterViewStateLoading: {
        ...
        case MCRefreshTableFooterViewStateEnd: {
            self.buttonLoadMore.hidden = YES;
            self.viewLoading.hidden = YES;
            [self.activityView stopAnimating];
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        self.state = MCRefreshTableFooterViewStateNormal;
    }
    return self;
}
